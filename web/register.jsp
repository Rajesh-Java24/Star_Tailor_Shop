...
<head>
    ...
    margin-top: 140px; /* Increase space from the top */
    margin-bottom: 60px; /* Add space from the bottom */
    left: 50%;
...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            //String query ="(exec add_users ?,?,?,?,?)";
            PreparedStatement pst = conn.prepareStatement("exec add_users ?,?,?,?,?");
            ...
            if (result > 0) {
               // JOptionPane.showMessageDialog(null,"Registration successful");
                out.println("<div class='alert alert-success' role='alert'>Registration successful. <a href='login.jsp'>Login here</a></div>");
            } else {
            ...
            e.printStackTrace();
            out.println("<div class='alert alert-danger' role='alert'>Error occurred during registration. Please try again.</div>");
        }
    }
%>
        ...
        <div class="col-md-12">
            <div class="form-container">
                ...
                <form method="post" action="register.jsp">
                    ...
                    <p>If already a user, <a href="login.jsp">click here</a></p>
                </form>
            </div>
        </div>
    </div>
